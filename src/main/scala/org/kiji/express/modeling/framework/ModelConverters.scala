...
object ModelConverters {
   ...
   */
  def inputSpecsFromAvro(inputSpecs: java.util.Map[String, AvroInputSpec]): Map[String,
      InputSpec] = {
   ...
   */
  def inputSpecsToAvro(inputSpecs: Map[String, InputSpec]): java.util.Map[String,
      AvroInputSpec] = {
   ...
   * @return a map of [[org.kiji.express.modeling.config.InputSpec]].
   */
  def outputSpecsFromAvro(outputSpecs: java.util.Map[String, AvroOutputSpec]): Map[String,
    OutputSpec] = {
   ...
   * @return a Java map of avro records.
   */
  def outputSpecsToAvro(outputSpecs: Map[String, OutputSpec]): java.util.Map[String,
    AvroOutputSpec] = {
